    ...
    public class DBManager
    {
        ...
        public static List<Account> GetAllAccounts()
        {
            ...
            try
            {
                ...
                cmd.Connection = con;
                string query = "SELECT acct.type, acct.branch, acct.balance, cust.name, cust.address, cust.PAN, cust.mobile FROM account acct, customer cust where cust.id=acct.cust_id";
